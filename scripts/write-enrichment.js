...
const sql = `-- See Yunnan M1.5 city content enrichment
...
fs.writeFileSync('E:/无尽的/see-yunnan/supabase/seed/city_content_enrichment.sql', sql, 'utf8');
console.log('sql bytes', fs.statSync('E:/无尽的/see-yunnan/supabase/seed/city_content_enrichment.sql').size);
